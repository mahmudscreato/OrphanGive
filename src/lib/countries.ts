// Compact country list (ISO 3166-1 alpha-2 + name + dial code).
// Sourced from the standard list. Keep alphabetical except Bangladesh first
// (default for our signup form's primary market).

export type Country = {
  code: string; // ISO 3166-1 alpha-2
  name: string;
  dial: string; // E.164 country code prefix (with leading +)
};

const PRIMARY: Country = { code: "BD", name: "Bangladesh", dial: "+880" };
...
export const COUNTRIES: readonly Country[] = [PRIMARY, ...REST];
