  ...
  if (submitted) {
    return (
      <div className="rounded-3xl bg-moss-soft/60 border border-moss/30 px-6 py-6">
        ...
        <Link
          href="/signin"
          className="mt-5 inline-flex items-center justify-center gap-2 rounded-full bg-orange-solid text-white font-body font-semibold py-3 px-6 text-base transition-all duration-[250ms] ease-soft hover:bg-tangerine-deep hover:shadow-warm hover:-translate-y-px"
        >
          Go to sign in
