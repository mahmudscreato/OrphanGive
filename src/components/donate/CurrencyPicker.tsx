...
export function CurrencyPicker({ current, options, fromPath }: Props) {
  ...
  return (
    <div ref={ref} className="relative inline-block">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        disabled={isPending}
        className="inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-[13px] font-medium text-ink shadow-sm ring-1 ring-stone-200 hover:ring-tangerine focus:outline-none focus:ring-2 focus:ring-tangerine disabled:opacity-60"
